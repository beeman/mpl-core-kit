...
): GetDiscriminatedUnionVariant<BasePluginAuthorityArgs, '__kind', 'UpdateAuthority'>
export function basePluginAuthority(
  kind: 'Address',
  data: GetDiscriminatedUnionVariantContent<BasePluginAuthorityArgs, '__kind', 'Address'>,
): GetDiscriminatedUnionVariant<BasePluginAuthorityArgs, '__kind', 'Address'>
export function basePluginAuthority<K extends BasePluginAuthorityArgs['__kind'], Data>(kind: K, data?: Data) {
  return Array.isArray(data) ? { __kind: kind, fields: data } : { __kind: kind, ...(data ?? {}) }
}
export function getBasePluginAuthorityCodec(): Codec<BasePluginAuthorityArgs, BasePluginAuthority> {
...
): value is { __kind: K } & BasePluginAuthority {
