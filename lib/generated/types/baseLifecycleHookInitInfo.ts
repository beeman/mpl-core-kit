...
export function getBaseLifecycleHookInitInfoCodec(): Codec<BaseLifecycleHookInitInfoArgs, BaseLifecycleHookInitInfo> {
  return combineCodec(getBaseLifecycleHookInitInfoEncoder(), getBaseLifecycleHookInitInfoDecoder())
}

export function getBaseLifecycleHookInitInfoDecoder(): Decoder<BaseLifecycleHookInitInfo> {
...
export function getBaseLifecycleHookInitInfoEncoder(): Encoder<BaseLifecycleHookInitInfoArgs> {
