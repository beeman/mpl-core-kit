...
export type ExecuteV1Instruction<
  ...
  TAccountAssetSigner extends AccountMeta<string> | string = string,
  ...
  TAccountProgramId extends AccountMeta<string> | string = 'CoREENxT6tW1HoK8ypY1SxRMZTcVPm7R94rH4PZNhX7d',
...
> = Instruction<TProgram> &
  InstructionWithAccounts<
    [
      ...
      TAccountAssetSigner extends string ? ReadonlyAccount<TAccountAssetSigner> : TAccountAssetSigner,
...
> {
  ...
  const originalAccounts = {
    ...
    assetSigner: { isWritable: false, value: input.assetSigner ?? null },
    ...
    programId: { isWritable: false, value: input.programId ?? null },
...
export function parseExecuteV1Instruction<TProgram extends string, TAccountMetas extends readonly AccountMeta[]>(
