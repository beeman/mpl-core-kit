...
> {
  ...
  const instruction = {
    ...
    data: getUpdatePluginV1InstructionDataEncoder().encode(args as UpdatePluginV1InstructionDataArgs),
    programAddress,
...
export function parseUpdatePluginV1Instruction<TProgram extends string, TAccountMetas extends readonly AccountMeta[]>(
