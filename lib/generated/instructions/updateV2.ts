...
export type UpdateV2Instruction<
  ...
  TAccountNewCollection extends AccountMeta<string> | string = string,
  ...
  InstructionWithAccounts<
    [
      ...
      TAccountAuthority extends string
        ...
        : TAccountAuthority,
      TAccountNewCollection extends string ? WritableAccount<TAccountNewCollection> : TAccountNewCollection,
...
> {
  ...
  const originalAccounts = {
    ...
    newCollection: { isWritable: true, value: input.newCollection ?? null },
...
export function parseUpdateV2Instruction<TProgram extends string, TAccountMetas extends readonly AccountMeta[]>(
