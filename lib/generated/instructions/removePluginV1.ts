...
import { getPluginTypeDecoder, getPluginTypeEncoder, type PluginType, type PluginTypeArgs } from '../types'
...
> {
  ...
  const instruction = {
    ...
    data: getRemovePluginV1InstructionDataEncoder().encode(args as RemovePluginV1InstructionDataArgs),
    programAddress,
...
export function parseRemovePluginV1Instruction<TProgram extends string, TAccountMetas extends readonly AccountMeta[]>(
